...
public class JamesHelper {
  ...
  private void initTelnetSession() {
    ...
    //Don't know why it doesn't allow login at the first attemot
    readUntil("Login id:");
    write("");
    readUntil("Password:");
    write("");
  ...
  public List<MailMessage> waiForMAil(String username, String password, long timeout) throws InterruptedException, MessagingException {
